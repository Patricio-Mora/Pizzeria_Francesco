...
def create_pizza():
    data = request.json
    new_pizza = Pizza(variedad=data['variedad'], ingredientes=data['ingredientes'], tamanio=data['tamanio'], precio_salon=data['precio_salon'], precio_delivery=data['precio_delivery'])
    new_pizza.save()
...
def update_pizza(pizza_id):
    ...
    pizza.precio_salon = data['precio_salon']
    pizza.precio_delivery = data['precio_delivery']
    pizza.save()

...
def create_pizza():
    data = request.json
    new_pizza = Pizza(variedad=data['variedad'], ingredientes=data['integrantes'], tamanio=data['tamanio'], precio_salon=data['precio_salon'], precio_delivery=data['precio_delivery'])
    new_pizza.save()

...
async function showPizzas(){
  ...
  pizzas.forEach((pizza,index) => {
    let tr = `<tr>
                  ...
                  <td>
                      <button class="enviar" id="actualizar" onclick='updatePizza(${pizza.id_pizza})'> <i class="fa fa-pencil" > Actualizar </button></i>
                      <button class="enviar" id="borrar" onclick='deletePizza(${pizza.id_pizza})'>  <i class="fa fa-trash" > Borrar </button></i>
                  </td>
                </tr>`;
